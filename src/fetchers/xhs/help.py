...
from ...infrastructure.utils.crawler_util import extract_url_params_to_dict
...
def get_b3_trace_id():
    re_str = "abcdef0123456789"
    je = 16
    e = ""
    for t in range(16):
        e += re_str[random.randint(0, je - 1)]
    return e
...
lookup = [
    "Z", "m", "s", "e", "r", "b", "B", "o", "H", "Q", "t", "N", "P", "+", "w", "O", "c", "z", "a", "/",
    "L", "p", "n", "g", "G", "8", "y", "J", "q", "4", "2", "K", "W", "Y", "j", "0", "D", "S", "f", "d",
    "i", "k", "x", "3", "V", "T", "1", "6", "I", "l", "U", "A", "F", "M", "9", "7", "h", "E", "C", "v",
    "u", "R", "X", "5",
]
